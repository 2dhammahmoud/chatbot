...
const RESPONSES_DATA = {
    ...
    "interview_questions": [
        ...
        {
            "field": "Growing_Stress", "question": "(نعم / لا / يمكن) هل بتحس إن ضغوطك اليومية بتزيد مؤخرًا؟",
            "answer_replies": {
        ...
        {
            "field": "Changes_Habits", "question": " (نعم / لا / يمكن)هل لاحظت أي تغيير مفاجئ في عاداتك اليومية زي الأكل أو النوم؟",
            "answer_replies": {
        ...
        {
            "field": "Days_Indoors", "question": "(مثال: بخرج كل يوم / أغلب الوقت في البيت / نادرًا جدًا بخرج) بتقضي وقت قد إيه غالبًا جوه البيت؟",
            "answer_replies": {
        ...
        {
            "field": "Mood_Swings", "question": " ( مثال : مرتفعة / متوسطة / منخفضة )حدة تقلبات مزاجك إيه؟",
            "answer_replies": {
        ...
        {
            "field": "Coping_Struggles", "question": "(نعم / لا / يمكن) هل بتحس بصعوبة في التعامل أو مواجهة المشاكل دي لوحدك؟",
            "answer_replies": {
        ...
        {
            "field": "Work_Interest", "question": "(نعم / لا / يمكن) هل لسه عندك شغف تجاه شغلك أو دراستك؟",
            "answer_replies": {
        ...
        {
            "field": "Social_Weakness", "question": "(نعم / لا / يمكن) هل بقيت بتميل إنك تكون لوحدك أكتر؟",
            "answer_replies": {
        ...
        {
            "field": "Mental_Health_History", "question": "(نعم / لا / يمكن) هل كان عندك تاريخ سابق مع تحديات نفسية؟",
            "answer_replies": {
        ...
        {
            "field": "family_history", "question": "(نعم / لا / يمكن) هل فيه أي حد في عيلتك المقربة عنده تاريخ مرضي نفسي معروف؟",
            "answer_replies": {
        ...
        {
            "field": "care_options", "question": "(نعم / لا / يمكن) هل إنت عارف إيه خيارات الرعاية المتاحة ليك لو احتجت؟",
            "answer_replies": {
        ...
        {
            "field": "mental_health_interview", "question": "(نعم / لا / يمكن) أخيرًا، هل عندك استعداد تتكلم مع متخصص نفسي لو احتاج ده؟",
            "answer_replies": {
